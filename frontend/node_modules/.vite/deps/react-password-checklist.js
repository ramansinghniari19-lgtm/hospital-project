...
import { t as require_react } from "./react-zm2fn-FP.js";

//#region node_modules/react-password-checklist/dist/index.js
...
var valueHasCapitalCharacters = function(value) {
	...
	while (i < value.length) {
		...
		if (character == character.toLowerCase()) {} else if (character == character.toUpperCase()) return true;
		i++;
	}
	return false;
};
var valueHasLowercaseCharacters = function(value) {
	...
	while (i < value.length) {
		var character = value.charAt(i);
		if (character == character.toUpperCase()) {} else if (character == character.toLowerCase()) return true;
		i++;
	}
	return false;
};
var ReactPasswordChecklist = function(_a) {
	var className = _a.className, style = _a.style, rules = _a.rules, value = _a.value, valueAgain = _a.valueAgain, minLength = _a.minLength, maxLength = _a.maxLength, rtl = _a.rtl, onChange = _a.onChange, _b = _a.specialCharsRegex, specialCharsRegex = _b === void 0 ? /[~`¿¡!#$%\^&*€£@+÷=\-\[\]\\';,/{}\(\)|\\":<>\?\.\_]/g : _b, _c = _a.messages, messages = _c === void 0 ? {} : _c, remainingProps = __rest(_a, [
		"className",
		"style",
		"rules",
		"value",
	...
	var ruleDefinitions = {
		minLength: {
			...
			message: messages.minLength || "Password has at least ".concat(minLength, " characters.")
		},
		specialChar: {
		...
		capitalAndLowercase: {
			...
			message: messages.capitalAndLowercase || "Password contains at least one uppercase and lowercase characters."
		},
		letter: {
	...
	var enabledRules = (0, import_react.useMemo)(function() {
	...
	var failedRules = (0, import_react.useMemo)(function() {
	...
	(0, import_react.useEffect)(function() {
		if (typeof onChange === "function") onChange(isValid, failedRules);
	}, [isValid, failedRules]);
	if (rtl) className = className ? className + " rtl" : "rtl";
	return import_react.createElement("ul", {
		...
		return import_react.createElement(Rule, __assign({
			key: rule,
			valid,
			iconSize: 18,
			validColor: "#4BCA81",
...
var Rule = function(_a) {
	...
	return import_react.createElement("li", {
		className: "".concat(itemClassName, " ").concat(valid ? "valid" : "invalid"),
		style: {
			listStyleType: "none",
			display: "flex",
			alignItems: "center",
	...
	}, !hideIcon ? iconComponents ? valid ? iconComponents.ValidIcon : iconComponents.InvalidIcon : import_react.createElement("svg", {
	...
	})) : null, import_react.createElement("span", { style: {
		paddingTop: 2,
		opacity: valid ? 1 : !invalidTextColor ? .5 : void 0,
		flex: 1,
...
//#endregion
export { ReactPasswordChecklist as default };
//# sourceMappingURL=react-password-checklist.js.map